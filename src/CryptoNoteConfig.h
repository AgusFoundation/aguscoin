...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 2361;
...
const char     CRYPTONOTE_NAME[]                             = "xcash";
...
const char* const SEED_NODES[] = { "192.168.56.1:20334" , "192.168.56.101:20334" };
